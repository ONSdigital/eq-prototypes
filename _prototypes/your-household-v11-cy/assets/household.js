...
export const tempAwayQuestionSentenceMap = {
  'three-more': 'Pobl sy\'n byw y tu allan i\'r Deyrnas Unedig fel arfer, ond sy\'n aros yn y Deyrnas Unedig am <strong>3 mis neu fwy</strong>',
  'perm-away': 'Pobl sy\'n gweithio i ffwrdd o\'r cartref yn y Deyrnas Unedig, os mai hwn yw eu cartref parhaol neu gartref y teulu',
  'armed-forces': 'Aelodau o\'r lluoedd arfog (er enghraifft, y fyddin), os mai hwn yw eu cartref' +
    ' parhaol neu gartref y teulu',
  'less-twelve': 'Pobl sydd y tu allan i\'r Deyrnas Unedig dros dro am lai na <strong>12 mis</strong>',
  ...
  'other': 'Pobl eraill sy\'n byw yma fel arfer, ond sydd i ffwrdd dros dro'
};
